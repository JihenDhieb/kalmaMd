...
export default function TermsPage() {
  ...
  return (
    <section className="mx-auto grid max-w-3xl gap-6 px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div>
        <p className="text-sm font-bold uppercase tracking-wide text-primary-700">{t("legal.legalInformation")}</p>
        <h1 className="mt-3 text-3xl font-bold text-foreground">{t("legal.termsTitle")}</h1>
      </div>
      <Card>
        <div className="grid gap-4 text-sm leading-7 text-stone-700">
          <p>{t("legal.termsDescription")}</p>
          <p>{t("legal.termsCardCopy")}</p>
